...
/**
 * Created by szagoret on 13.10.2016.
 */
public class ConsumptionStepExecutionListener {

    Logger LOG = LoggerFactory.getLogger(ConsumptionStepExecutionListener.class);
    ...
    public void beforeStep(StepExecution stepExecution) {
        ...
        String importType = "calcul consumption";
        String importFormat = "couchbase";
